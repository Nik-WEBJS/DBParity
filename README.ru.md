...
> **Статус: v0.9 alpha.** Ядро (100 тестов) обкатывается в CI на живых
> PostgreSQL и SQL Server. Интерфейс инструмента (CLI, отчёты, консоль)
> теперь английский — это язык международного опенсорса; README на русском
> остаётся. Сверка переживает обрывы сети (checkpoint/resume
